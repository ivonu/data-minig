...
\begin{figure}
\centering
\includegraphics[scale=.5]{func.eps}
...
For the mapper functionality we chose to implement the PEGASOS \cite{shalev2011pegasos} algorithm discussed in the lecture.
...
This transformation indeed seems to make sense when looking at figure \ref{fig:mean-var}. Both mean and variance are somewhat scattered.

\begin{figure}[H]
\centering
\begin{subfigure}{.4\textwidth}
  \centering
  \includegraphics[scale=0.35]{../../project02-svm/doc/feature-mean.eps}
  \caption{Feature Mean}
  \label{fig:sub1}
\end{subfigure}%
\begin{subfigure}{.4\textwidth}
  \centering
  \includegraphics[scale=0.35]{../../project02-svm/doc/feature-variance.eps}
...
\subsection{Additional Features Created}
TODO
